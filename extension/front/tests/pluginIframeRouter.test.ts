...
const mockPoF = {
  ...
  setYaraResults: (_m: any, _e: any) => Promise.resolve(undefined),
  setCapaResults: (_c: any, _e: any) => Promise.resolve(undefined),
  setDetectionMeta: (_d: any) => Promise.resolve(undefined),
  getDetectionState: () => Promise.resolve({}),
  clearDetectionState: () => Promise.resolve(undefined),
  setLoading: (_id: string, _msg: string) => Promise.resolve(undefined),
  renderRulesList: (_id: string, _rules: any) => Promise.resolve(undefined),
  applyYaraModeUi: () => Promise.resolve(undefined),
  getYaraMode: () => Promise.resolve('manual'),
  setYaraMode: (_mode: string, _opts?: any) => Promise.resolve(undefined),
